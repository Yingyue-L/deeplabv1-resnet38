...
if __name__ == '__main__':
    ...
    parser.add_argument("--list", default='../../data/VOCdevkit/VOC2012/ImageSets/Segmentation/train.txt', type=str)
    parser.add_argument("--predict_dir", default='AffinityNet@resnet38@WeakTr@trainaug@beta=10@exp_times=8@rw@power2.5@crf', type=str)
    parser.add_argument("--gt_dir", default='../../data/VOCdevkit/VOC2012/SegmentationClassAug', type=str)
